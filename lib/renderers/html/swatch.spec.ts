...
describe('getSwatch', () => {
  it('creates a swatch for a color token', () => {
    ...
    expect(swatch).to.equal('<section class="swatch color-black" style="background-color: #000000; color: #ffffff;"><h4>color.black</h4><table><tr><th>Hex</th><td>#000000</td></tr><tr><th>RGBA</th><td>0, 0, 0, 1</td></tr><tr><th>CMYKA</th><td>0, 0, 0, 100, 1</td></tr><tr><th>HSLA</th><td>0°, 0, 0, 1</td></tr><tr><th>HSVA</th><td>0°, 0, 0, 1</td></tr></table></section>')
  })
  ...
  it('creates a swatch for a different color token', () => {
    ...
    expect(swatch).to.equal('<section class="swatch color-white" style="background-color: #ffffff; color: #000000;"><h4>color.white</h4><table><tr><th>Hex</th><td>#ffffff</td></tr><tr><th>RGBA</th><td>255, 255, 255, 1</td></tr><tr><th>CMYKA</th><td>0, 0, 0, 0, 1</td></tr><tr><th>HSLA</th><td>0°, 0, 100, 1</td></tr><tr><th>HSVA</th><td>0°, 0, 100, 1</td></tr></table></section>')
  })

  it('uses $description for title if available', () => {
    const token: DerefColorToken = { $type: 'color', $value: '#000000', $description: 'Black' }
    const swatch = getSwatch('color.black', token)
    expect(swatch).to.equal('<section class="swatch color-black" style="background-color: #000000; color: #ffffff;"><h4>Black</h4><table><tr><th>Hex</th><td>#000000</td></tr><tr><th>RGBA</th><td>0, 0, 0, 1</td></tr><tr><th>CMYKA</th><td>0, 0, 0, 100, 1</td></tr><tr><th>HSLA</th><td>0°, 0, 0, 1</td></tr><tr><th>HSVA</th><td>0°, 0, 0, 1</td></tr></table></section>')
  })
  ...
  it('includes module in SCSS variable if available', () => {
    ...
    const swatch = getSwatch('color.black', token)
    expect(swatch).to.equal('<section class="swatch color-black" style="background-color: #000000; color: #ffffff;"><h4>color.black</h4><table><tr><th>Hex</th><td>#000000</td></tr><tr><th>RGBA</th><td>0, 0, 0, 1</td></tr><tr><th>CMYKA</th><td>0, 0, 0, 100, 1</td></tr><tr><th>HSLA</th><td>0°, 0, 0, 1</td></tr><tr><th>HSVA</th><td>0°, 0, 0, 1</td></tr><tr><th>SCSS</th><td>colors.$black</td></tr></table></section>')
  })
})
