...
describe('renderSCSS', () => {
  it('renders color tokens', () => {
    ...
    expect(renderSCSS(list)).to.equal('$color-primary-green: #008800;')
  })

  it('renders dimension tokens', () => {
    const list: DerefTokenList = { 'breakpoint.primary': { $type: 'dimension', $value: '40rem' } }
    expect(renderSCSS(list)).to.equal('$breakpoint-primary: 40rem;')
  })
  ...
  it('renders a specified subset of a list', () => {
    ...
    expect(renderSCSS(list, { prefix: 'color.primary' })).to.equal('$color-primary-green: #008800;')
  })
  ...
  it('renders tokens with prefixes added', () => {
    const list: DerefTokenList = { 'color.primary.green': { $type: 'color', $value: '#008800' } }
    expect(renderSCSS(list, { add: 'test.case' })).to.equal('$test-case-color-primary-green: #008800;')
  })

  it('renders tokens with prefixes removed', () => {
    const list: DerefTokenList = { 'color.primary.green': { $type: 'color', $value: '#008800' } }
    expect(renderSCSS(list, { remove: 'color.primary' })).to.equal('$green: #008800;')
  })

  it('renders tokens with one prefix added and another removed', () => {
    const list: DerefTokenList = { 'color.primary.green': { $type: 'color', $value: '#008800' } }
    expect(renderSCSS(list, { add: 'test.case', remove: 'color.primary' })).to.equal('$test-case-green: #008800;')
  })
  ...
  it('renders transition tokens', () => {
    ...
    expect(renderSCSS(list)).to.equal('$transition-standard: 200ms cubic-bezier(0, 0, 0, 0) 0ms;')
  })
  ...
  it('renders shadow tokens', () => {
    ...
    expect(renderSCSS(list)).to.equal('$shadow-standard: 0.5rem 0.5rem 1.5rem 0rem #00000080;')
  })
  ...
  it('renders gradient tokens', () => {
    ...
    expect(renderSCSS(list)).to.equal('$gradient-monochrome: #000000 0%, #ffffff 100%;')
  })
  ...
  it('renders typography tokens', () => {
    ...
    expect(renderSCSS(list)).to.equal('$typography-body: normal 1rem/1.2rem "Helvetica", "Arial", sans-serif;\n$typography-body-letter-spacing: 0rem;')
  })
  ...
  it('renders typography tokens with font style', () => {
    ...
    expect(renderSCSS(list)).to.equal('$typography-emphasized: italic normal 1rem/1.2rem "Helvetica", "Arial", sans-serif;\n$typography-emphasized-letter-spacing: 0rem;')
  })
  ...
  it('can render all of them from the same list', () => {
    ...
    expect(renderSCSS(list)).to.equal(expected)
  })
})
